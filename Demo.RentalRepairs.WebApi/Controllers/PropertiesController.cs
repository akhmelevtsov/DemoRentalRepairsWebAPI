...
namespace Demo.RentalRepairs.WebApi.Controllers
{
    ...
    public class PropertiesController : ControllerBase
    {
        ...
        public void Post([BindRequired, FromBody] PropertyModel prop)
        {
            ...
            //}
            _propertyService.RegisterPropertyAsync(new RegisterPropertyCommand(prop.Name, prop.Code, prop.Address, prop.PhoneNumber, prop.Superintendent, prop.Units.ToList(), prop.NoReplyEmailAddress ) );
        }
